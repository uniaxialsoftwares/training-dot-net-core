...
*/
          ...
          /*  Fan objFan1 = new Fan();
            ...
            */
            ...
            // Day 7
            DateTime dtDoE = DateTime.Now;
            dtDoE = dtDoE.AddYears(10);

            //DateTime  dtDoE = new DateTime()
            InventoryItems fan = new InventoryItems(1, "Fan",
                "Electromax", dtDoE, 1000);
            ...
            //
            string name_replaced = name.Replace("r", "R");
            Console.WriteLine(name_replaced);

            // string split
            string[] names = name.Split(' ');
            Console.WriteLine("The Splited Output are: ");
